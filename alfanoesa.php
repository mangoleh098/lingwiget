...
if (isset($_POST['password'])) {
    ...
    $hashed_password = 'be6a7849056e35626bd3c15538e2c514'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    ...
    <html>
    <head>
        <title>هجوم الفجر</title>
    </head>
    <body bgcolor="gray">
        <center>
        <img src="https://media.tenor.com/bIKu7pYGr2cAAAAM/meme-memes.gif" />
